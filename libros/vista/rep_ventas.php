...
<center>
 <div  id="llenar_usuarios">
    ...
    <?php 
$sql=$conexion->query("SELECT t1.id_factura,
t2.nombre,
t2.apellido,
DATE_FORMAT(t1.fecha_venta , '%d/%m/%Y'),
t1.hora_venta,
t1.status,
t1.id_cliente,
SUM(d.total) AS t
...
INNER JOIN detalles_facturas d ON d.id_factura=t1.id_factura
...
while ($fila=$sql->fetch_array()) {
 ...
 <tr>
    ...
    <td><?php echo '000000000'.$fila[0] ?></td>
