...
// Creación del objeto de la clase heredada
  ...
  $pdf->Cell(80,10,"R.U.C:0000000000001",0,0,"C");

  $pdf->Cell(80,10,"FECHA:  ".$tmp['fecha_venta'],1,1,"L");
  $pdf->SetFont('Arial','i',12);
  $pdf->Cell(30,7,"",0,0,"C");
  $pdf->Cell(80,7,"Guamani",0,0,"C");
  ...
  $pdf->Cell(50,8," 001-".$codigo,1,1,"C");
  $pdf->SetFont('Arial','i',12);
  $pdf->SetTextColor(0,0,0);

  $pdf->Cell(30,7,"",0,0,"C");
  $pdf->Cell(80,7,"Av.Maldonado",0,1,"C");
  $pdf->Cell(30,7,"",0,0,"C");
  $pdf->Cell(80,7,"Frente a la estación Sur Eco Vía",0,1,"C");
